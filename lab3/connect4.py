...
class Connect4:
    ...
    #     copy=Connect4(connect4.width,connect4.height)
    #     copy.who_moves=connect4.who_moves
    #     copy.game_over=connect4.game_over
    #     copy.wins=connect4.wins
    #     copy.board = [row[:] for row in connect4.board] 
    #     return copy